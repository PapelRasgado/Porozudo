...
from bot.config import LAVALINK_PASSWORD, LAVALINK_PORT, LAVALINK_URL
...
class MusicCog(Cog):
    ...
    async def loop(
        ...
        if loop_type == 0:
            ...
            await ctx.respond(embed=Embed(description="Loop desligado. <a:stare:1362182891425103962>"))
        elif loop_type == 1:
            player.queue.mode = wavelink.QueueMode.loop
            await ctx.respond(embed=Embed(description="Loop ligado. <a:loop:1362182672952066108>"))
        elif loop_type == 2:
